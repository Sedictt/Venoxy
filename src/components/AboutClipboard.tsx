...
export default function AboutClipboard() {
  return (
    ...
    >
      ...
      <div 
        className="w-full min-h-[450px] sm:min-h-[650px] md:min-h-[850px] lg:min-h-[1000px] xl:min-h-[1150px] bg-cover bg-center bg-no-repeat transition-all duration-500 relative z-0"
